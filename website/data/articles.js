  ...
  },
  {
    ...
    signalPool: [
      ...
      },
      {
        ...
        signal: "AI HOT 全量信号记录 Claude Code 将支持查看技能、代理、MCP 和插件的 token 使用明细。",
  ...
  "2026-05-23": [
    {
      ...
      technical: [
        ...
        },
        {
          ...
          status: "策略模板",
          body:
            "按站点类型生成机器访问说明：允许抓取哪些内容、推荐 API/下载路径、署名要求、限流和联系邮箱。",
        },
        {
          title: "报告形态",
          status: "可转发",
